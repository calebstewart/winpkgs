...
Describe 'Registered resource types' {
    It 'includes the built-ins' {
        ...
        foreach ($t in 'winpkgs/registry', 'winpkgs/registryKey', 'winpkgs/winget', 'winpkgs/file', 'winpkgs/path', 'winpkgs/environment', 'winpkgs/font', 'winpkgs/wallpaper', 'winpkgs/powerPlan', 'winpkgs/powerSetting', 'winpkgs/hibernation', 'winpkgs/computerName', 'winpkgs/pointer') {
